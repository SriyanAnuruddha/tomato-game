...
export default function HowToPlay(props) {
    ...
    return (
        <Offcanvas show={props.show} onHide={handleClose}>
            ...
            <Offcanvas.Body>
                <p> The first player must solve the math equation given in the image within 3 minutes to find the value of the tomato. If the player fails to find the value within this time, the game will end.
                </p>
                ...
                <p>
                    After selecting the same value for all cubes, the player can click on the 'Check Answer' button to verify if the answer is correct or wrong. The player has 3 attempts to select the answer for each level; if they get the answer wrong, one life is deducted.
                </p>
